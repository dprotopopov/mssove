...
int main(){
	...
	cout << "\t”кажите режим (0 - непрерывное воздействе, 1 - однократное воздействие):" << endl; cin >> mode;

	cout << "\tƒемонстрационный режим програмы (0 - замер времени, 1 - демонстраци€ работоспособности):" << endl; cin >> demo;

	clock_t t = clock();
	if(jacobi_tor(n,m,x,value,mode, demo)!=0) cout << "\tќшибка аллокировани€ пам€ти" << endl;
	t = clock()-t;
